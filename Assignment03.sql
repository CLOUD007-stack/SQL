...
#Q2
SELECT DISTINCT feature_role.person AS ActorName,
                feature_role.role AS MCUCharacter,
                features.title AS MCUCharacterMovie
FROM feature_role
...
WHERE franchises.franchise_name = 'Marvel Cinematic Universe'
...
#Q3
SELECT franchises.franchise_name, features.title AS movie_title
FROM franchises 
JOIN features  ON franchises.franchise_id = features.franchise_id
...
#Q4
SELECT DISTINCT
    f1.franchise_name AS franchise_1,
    f2.franchise_name AS franchise_2,
    fe1.title AS movie_1,
    fe2.title AS movie_2,
    fw1.person AS common_actor
FROM 
    franchises f1
JOIN 
